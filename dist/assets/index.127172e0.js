...
`,P=a(k)`
  right: 40px;
`,z=()=>m(L,{children:[n(O,{}),n(G,{}),n(P,{}),"Wordle22"]});require("dotenv").config();const H=a.div`
  display: flex;
...
`,T=a(w)`
  width: 60px;
`,q=({enterWord:e,submitGuess:u,deleteWord:r})=>{const t=[["Q","W","E","R","T","Y","U","I","O","P"],["A","S","D","F","G","H","J","K","L"],["Z","X","C","V","B","N","M"]].map((s,l)=>m(U,{children:[l===2&&n(T,{status:"unused",onClick:()=>u(),children:"Enter"},"Enter"),s.map(p=>n(w,{status:"unused",value:p,onClick:()=>{e(p)},children:p},p)),l===2&&n(T,{status:"unused",onClick:()=>r(),children:"Back"},"Back")]},l));return n(H,{children:t})},Z=a.div`
  background-color: ${i.background_main};
  width: 500px;
  min-height: 100vh;
  display: flex;
  ...
  align-items: center;
  flex-direction: column;
`,J=()=>{const[e,u]=g.exports.useState([[["","","","",""],["","","","",""],["","","","",""],["","","","",""],["","","","",""],["","","","",""]],[["TBD","TBD","TBD","TBD","TBD"],["TBD","TBD","TBD","TBD","TBD"],["TBD","TBD","TBD","TBD","TBD"],["TBD","TBD","TBD","TBD","TBD"],["TBD","TBD","TBD","TBD","TBD"],["TBD","TBD","TBD","TBD","TBD"]]]);console.log(e),g.exports.useState(0);const[r,o]=g.exports.useState(0),[t,s]=g.exports.useState(0),[l,p]=g.exports.useState(["A","P","P","L","E"]),B=g.exports.useRef(!1),D=()=>{t!==0&&(u([e[0].map((c,d)=>r!==d?c:c.map((f,h)=>t-1!==h?f:"")),e[1]]),s(t-1))},_=c=>{t!==5&&(u([e[0].map((d,f)=>r!==f?d:d.map((h,F)=>t!==F?h:c)),e[1]]),s(t+1))},x=()=>{console.log("submit"),e[0][r].length===5&&(v(e[0][r]),o(r+1),s(0))},v=c=>{const d=[];for(let f in c)l.indexOf(c[f])!==-1?l[f]===c[f]?d.push("correct"):d.push("near"):d.push("wrong");u([e[0],e[1].map((f,h)=>r!==h?f:d)])},A=c=>{const d=/[a-z]|[A-Z]/;c.key.length===1&&d.test(c.key)?_(c.key.toUpperCase()):c.key==="Enter"?x():c.key==="Backspace"&&D()};return m(Z,{onKeyDown:c=>{B.current||A(c),B.current=!0},onKeyUp:()=>B.current=!1,tabIndex:-1,children:[n(z,{}),n(N,{currentMap:e}),n(q,{deleteWord:D,enterWord:_,submitGuess:x})]})};function M(){return m(j,{children:[n(W,{}),n("div",{className:"container",children:n(J,{})})]})}K.render(n(C.StrictMode,{children:n(M,{})}),document.getElementById("root"));
